...
<?php include_once './inc/nav-bar.php' ?>
    ...
    <div class="banner-main">
        <div class="container-banner" id="carousel-banner-1">
            <div class="banner banner-bespoke container">
        ...
        <div class = "our-services">
         ...
         <div class="m-device xl-device container">    
            <a href='#'>
        ...
        <h3 class="hidden-m"><a href="#" >View Our Work <span class="icon-arrow-right3"></span></a></h3>
...
<footer class="copyright ">
     <p class="container unhide" >&copy; Copyright Netmatters 2023. All rights reserved. &nbsp; &nbsp;-&nbsp;&nbsp; <a href="#">Sitemap</a></p>
     <p class="container hide">&copy; Copyright Netmatters 2023. <br>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-inner">
        ...
        <div class="sidebar-left-align">
            ...
            <div class="sidebar-covid"><a href="#">COVID RISK ASSESSMENTS</a></div>
            <div class="sidebar-support"><a href="#">SUPPORT</a></div>
        </div>
    </div>
